...
import { Package, Search, Plus, ChevronRight, AlertTriangle, Box, Check, X, FileText } from "lucide-react";
            ...
            <div className="max-w-7xl mx-auto space-y-8">
                ...
                <Tabs defaultValue="create" className="space-y-8">
                    ...
                    <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4 animate-in fade-in slide-in-from-top-4 duration-500">
                        ...
                        <TabsList className="bg-white p-1 rounded-2xl h-12 shadow-sm border border-neutral-100">
                            <TabsTrigger value="create" className="rounded-xl px-6 h-10 data-[state=active]:bg-neutral-900 data-[state=active]:text-white transition-all font-medium">
                                <Plus className="w-4 h-4 mr-2" /> New Receipt
                            </TabsTrigger>
                            <TabsTrigger value="history" className="rounded-xl px-6 h-10 data-[state=active]:bg-neutral-900 data-[state=active]:text-white transition-all font-medium">
                                <FileText className="w-4 h-4 mr-2" /> History
                            </TabsTrigger>
                        </TabsList>
                    </div>

                    <TabsContent value="create" className="space-y-8 focus-visible:outline-none animate-in fade-in zoom-in-95 duration-300">
