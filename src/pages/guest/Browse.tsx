...
export function Browse() {
    ...
    const getProductPrice = (product: any): number => {
        if (product.type_code === 'RETAIL') {
            ...
            return product.product_variants?.[0]?.product_preorder_configs?.deposit_amount || 0;
        }
        return 0;
    };
    ...
    const formatPrice = (product: any) => {
        ...
        if (product.type_code === 'RETAIL') {
            ...
            price = product.product_variants?.[0]?.product_preorder_configs?.deposit_amount || 0;
        }
                                        ...
                                        {(() => {
                                            ...
                                            return isOutOfStock && (
                                                <div className="absolute inset-0 bg-black/60 flex items-center justify-center z-10">
                                                    <span className="text-yellow-400 font-black uppercase tracking-widest text-xs border-2 border-yellow-400 px-3 py-1.5 transform -rotate-12">OUT OF STOCK</span>
                                                </div>
                                            );
                                        })()}
