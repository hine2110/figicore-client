...
import {
    Mail, Lock, User, Phone, ArrowRight, X
} from "lucide-react";
import { motion, AnimatePresence } from "framer-motion";
import "../../pages/guest/auth-ui.css";
...
export default function AuthModal({ isOpen, onClose, initialMode = 'login' }: AuthModalProps) {
    ...
    // Sync isActive with initialMode when it changes
    useEffect(() => {
    ...
    const handleRegSubmit = async (e: React.FormEvent) => {
        ...
        try {
            ...
            setRegMessage("Registration successful! Switching to Sign In...");
            setTimeout(() => {
                setIsActive(false);
                setRegMessage(null);
                setOtpSent(false);
                        ...
                        <div className={`auth-container ${isActive ? "active" : ""}`}>
                            ...
                            <div className="auth-form-container auth-sign-up">
                                <form className="auth-form-inner" onSubmit={handleRegSubmit}>
                                    ...
                                    <p className="auth-subtitle">Join the FigiCore premium community</p>
                                ...
                                <form className="auth-form-inner" onSubmit={handleLogin}>
                                    ...
                                    <div className="auth-input-group">
                                        <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center" }}>
                                            <label>Password</label>
                                            <Link to="/guest/forgot-password" onClick={onClose} className="auth-forgot">Forgot?</Link>
                                        </div>
                                        <div className="auth-input-wrapper">
                                            <Lock size={16} />
                                            <input
